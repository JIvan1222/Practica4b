/*
	Este archivo es la libreria, la cual se genera con rpegen en esta no movemos nada de codigo
	si movemos algo podiramos hacer que nuestro programa dejara de funcionar 
 */
